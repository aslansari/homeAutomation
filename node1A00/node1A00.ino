...
void loop(){
  ...
  if(radio.available()){
    ...
    String devicecommand(command);
    Serial.println("command="+devicecommand);
    String devicedata(mdata);
    Serial.println("data="+devicedata);      
    
    if(deviceaddress=="1A00"){
